    ...
    <el-container>
      <el-main style="padding: 0; margin-left: 10px">
        ...
        >
          ...
          <el-table-column :label="'接口总数 ('+total+')'" width="150" align="center">
            <template slot-scope="scope">
          ...
          <el-table-column label="操作" width="230" align="center">
            <template slot-scope="scope">
              <el-button size="small" type="success" @click="handleCellClick(scope.row)">查看</el-button>
