      ...
      <el-main style="padding-top: 0px">
        ...
        <div style="margin-top:20px">
          <el-row :gutter="20">
            <el-col :span="12">
              <div
                style="border:2px solid rgba(184 202 213);padding:20px;height: 650px;position:relative"
              >
                <div
...
export default {
  ...
  methods: {
    ...
    saveTask() {
      ...
      if (this.scheduleId === "") {
        this.$api
          .addTask({ project: this.$route.params.id }, form)
          .then((resp) => {
            if (resp.status === 201) {
